package com.example.pproject.viewmodel.likestore;
...
public class LikeStoreViewModel extends AndroidViewModel {

    private LiveData<List<Store>> listLiveData;
    private StoreRepository storeRepository;

    public LikeStoreViewModel(@NonNull Application application) {
        super(application);
